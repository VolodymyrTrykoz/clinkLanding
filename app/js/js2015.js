...
$(document).ready(function () {
  var $reactPath = $('.react');
  var $honeycombPath = $('.honeycomb');
  var $stethoscopePath2 = $('.stethoscope');
  var $stethoscopePath1 = $('.stethoscopeDot');
  var reactPathLength = $reactPath[0].getTotalLength();
  var honeycombPathLength = $honeycombPath[0].getTotalLength();
  var stethoscopePath1Length = $stethoscopePath1[0].getTotalLength();
  var stethoscopePath2Length = $stethoscopePath2[0].getTotalLength();
  var svgBlocksHeight = $('.about__items').height();
  var largeScreen = $(window).innerWidth() > 1024;
  var svgAnimationFired = false;
  var presentationOffset = $('.presentation__wrapper').offset().top;
  var windowHeight = $(window).height();
  var presentationFired = false;
  ...
  function runPresentationScene() {
    var tl = new TimelineMax();
    tl.fromTo('.presentation__wrapper .container', 1, { y: 20, opacity: 0 }, { y: 0, opacity: 1 }).fromTo('.personal__wrapper', 1, { y: 20, opacity: 0 }, { y: 0, opacity: 1 });
    presentationFired = true;
  }
  function runFirstAnimation() {
    var tl = new TimelineMax();
    tl.staggerFromTo(['.header__item', '.greeting__wrapper h1', '.greeting__wrapper h2'], 1, { y: 20, opacity: 0 }, { y: 0, opacity: 1 }, .5).fromTo('.about__info', 1, { y: 20, opacity: 0 }, { y: -100, opacity: 1 });
  }
  function runSvgScene() {
    var tl = new TimelineMax();
    tl.staggerFromTo('.item', 1, { y: 20 }, { y: 0, opacity: 1, onComplete: drawSVG }, .5);
  }
  function drawSVG() {
    var tlMenu = new TimelineMax();
    tlMenu.to($honeycombPath, 3, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($stethoscopePath2, .5, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($stethoscopePath1, .5, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($reactPath, 2, { strokeDashoffset: 0, ease: Power1.easeInOut }).to($honeycombPath, .2, { fill: '#69d2e7' }).to($stethoscopePath2, .1, { fill: '#69d2e7' }).to($stethoscopePath1, .1, { fill: '#69d2e7' }).to($reactPath, .2, { fill: '#69d2e7' });
